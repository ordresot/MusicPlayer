package com.tushar.voidplayer.service
...
import com.tushar.voidplayer.VoidPlayerApp
import com.tushar.voidplayer.ui.components.LiveWaveform
import com.tushar.voidplayer.toImageBitmap
import com.tushar.voidplayer.ui.components.formatTime
import com.tushar.voidplayer.getDominantColor
...
class OverlayService : Service(), LifecycleOwner, SavedStateRegistryOwner {
    ...
    private fun ExpandedIsland(
        ...
        art: ByteArray?,
        isPlaying: Boolean, 
        player: com.tushar.voidplayer.player.AudioPlayer, 
        accentColor: Color,
        onPrev: () -> Unit,
        onNext: () -> Unit,
        onPlayPause: () -> Unit
    ...
    @Composable
    private fun ExpandedProgress(song: Song, player: com.tushar.voidplayer.player.AudioPlayer, accentColor: Color) {
